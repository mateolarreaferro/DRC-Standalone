...
; FM of the grain pitch (playback speed)
	kFMratio	= p8
	kPtchFmFreq	= kgrainrate * kFMratio		; FM freq, 		Modulating waveform pitch
	kPtchFmIndex	= p7				; FM index, 		Modulating waveform pitch
	iPtchFmWave	= giSine			; FM waveform, 		Modulating waveform pitch
	ifmamptab	ftgentmp 0, 0, 16, -2, 0, 0, 1	; FM index scalers, 	per grain
	ifmenv		= giTriangleWin 		; FM index envelope, 	over each grain (from table)
	kPtchFmIndex	= kPtchFmIndex + (kPtchFmIndex*kPtchFmFreq*0.00001) 	; FM index scaling formula
...
a1,a2,a3,a4,a5,a6,a7,a8	partikkel \
		  ...
		  awavfm, ifmamptab, ifmenv, \				; FM synthesis parameters
...
; Modulation frequency bellow 20 Hz. Resulting in spectral sweeps
	;instr     start	dur	amp	pch	grPitch	FMindex	FMratio
	i	3	0	.7	.5	8	1	1	0.01
	i	3	^+1	.7	.	8.04	.	.	.
	i	3	^+1	1.5	.	8.02	.	.	.

; FM ratio at 1, showing similar spectral behaviour as regular FM
	;instr     start	dur	amp	pch	grPitch	FMindex	FMratio
	i	3	^+2	.7	.	8	.	.	1
	i	3	^+1	.7	.	8.04	.	.	.
	i	3	^+1	1.5	.	8.02	.	.	.

; FM ratio at 5, showing brighter, but similar spectral behaviour as FM ratio at 1
; which shows that FM in GS differs from regular FM. The harmonics of GS is dominating
	;instr     start	dur	amp	pch	grPitch	FMindex	FMratio
	i	3	^+2	.7	.	8	.	.	5
	i	3	^+1	.7	.	8.04	.	.	.
	i	3	^+1	1.5	.	8.02	.	.	.

; Complex FM ratio, resulting in drop of pitch
	;instr     start	dur	amp	pch	grPitch	FMindex	FMratio
	i	3	^+2	.7	.	8	.	.	.5
	i	3	^+1	.7	.	8.04	.	.	.
	i	3	^+1	1.5	.	8.02	.	.	.

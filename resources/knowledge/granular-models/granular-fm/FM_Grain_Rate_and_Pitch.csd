...
; FM av grain rate
	...
	kGrFMratio	= p8
	kGrFmIndex	= p7
	kGrFMmodFrek	= kGrFMratio * kgrainrate	; FM freq, 	modulating waveform pitch
	iGrFmWave	= giSine			; FM waveform, 	modulating waveform
	kGrFmIndex	= kGrFmIndex * kgrainrate	; FM index scaling formula
	aGrRateFm	oscil	kGrFmIndex, kGrFMmodFrek, iGrFmWave	; Modulator signal for frequency modulation of grain rate
...
; FM av grain pitch (playback speed)
	
	kPtchFMratio 	= p10				; FM freq,	modulating waveform pitch
	kPtchFmFreq	= kPtchFMratio * kgrainrate	; FM freq,	modulating waveform pitch
	kPtchFmIndex	= p9				; FM index,	modulating waveform pitch
	iPtchFmWave	= giSine			; FM waveform,	modulating waveform pitch
	ifmamptab	ftgentmp	0, 0, 16, -2, 0, 0,   1	; FM index scalers, per grain
	ifmenv		= giTriangleWin 				; FM index envelope, over each grain (from table)
	kPtchFmIndex	= kPtchFmIndex + (kPtchFmIndex*kPtchFmFreq*0.00001) 	; FM index scaling formula
	awavfm		oscili	kPtchFmIndex, kPtchFmFreq, iPtchFmWave		; Modulator signal for frequency modulation inside grain
...
<CsScore>
	; Grain rate modulation with Modulation ratio at 0.5
	; 
	;							Grain rate FM	Grain Pitch FM
	;instr     start	dur	amp	grRate	grPitch	FMindex	FMratio	FMindex	FMratio
	i	3	0	.7	0.5	9	1	0.5	0.5	0	.33333333333333333
	i	3	^+1	.7	.	9.04	.	.	.	.	.
	i	3	^+1	1.5	.	9.02	.	.	.	.	.


	; Grain Pitch modulation with modulation ratio at 0.3
	;							Grain rate FM	Grain Pitch FM
	;instr     start	dur	amp	grRate	grPitch	FMindex	FMratio	FMindex	FMratio
	i	3	^+2	.7	0.5	9	1	0	0.5	0.5	.33333333333333333
	i	3	^+1	.7	.	9.04	.	.	.	.	.
	i	3	^+1	1.5	.	9.02	.	.	.	.	.
	...
	;							Grain rate FM	Grain Pitch FM
	;instr     start	dur	amp	grRate	grPitch	FMindex	FMratio	FMindex	FMratio
	i	3	^+2	.7	0.5	9	1	0.5	0.5	0.5	.33333333333333333
	i	3	^+1	.7	.	9.04	.	.	.	.	.
	i	3	^+1	1.5	.	9.02	.	.	.	.	.

...
istrtf1	table  	3,40	; Start Frequency1
ifdec1	table  	4,40	; Frequency Decay Speed 1
istrtf2	table  	5,40	; Start Frequency 2
ifdec2	table  	6,40	; Frequency Decay Speed 2
	
ibwx0	table  	7,40	; Noise Bandwidth Offset (Hz)
ibwx1	table  	8,40	; Noise Bandwith Osc Frequency
...
k_		port 	1,ibtime/ifdec1,istrtf1			; Calculate Base Frq
...
k_		expseg 	1,ibtime/iAM1d,0.5				; Amplitude Envelopes
...
k_		port 	0,ibtime/iLPd,iLPf				; Lowpass Filter
...
imax1	table	1,64		; 1: 1st Limiter/Max Lvl
idel1	table	2,64		; 1: Delay Time
idec1	table	3,64		; 1: Decay Time
iatt1	table	4,64		; 1: Attack Time
ifrq1	table	5,64		; 1: Lowpass Filter Frq
imax2	table	6,64		; 2: 2nd Limiter/Max Lvl
idel2	table	7,64		; 2: Delay Time
idec2	table	8,64		; 2: Decay Time
iatt2	table	9,64		; 2: Attack Speed
ifrq2	table	10,64	; 2: Lowpass Filter Frq
...
f 40 0 32 -2	1000.0	; Volume
		...
		0.05			; Release Time
		5.3333		; Start Frq 1
		20			; Frq Decay Speed 1
		0.5			; Start Frq 2
		256			; Frq Decay Speed 2
		0.0			; Noise Bandwith Offset (Hz)
		0.25			; Noise Bandwidth/Osc Frequency	
		4.0			; Lowpass Filter Start Frq/Osc Frq
		4.0			; Lowpass Filter Freq Decay Speed
		16.0			; Amplitude Envelope 1 Start Value		
		1024			; Amplitude Envelope 1 Decay Speed
		1.0			; Amplitude Envelope 2 Start Value
		4			; Amplitude Envelope 2 Decay Speed
;============================================================

;==================================================
f 64 0 16 -2	24576	; Output Gain
		4.0			; Limter 1/Max Lvl
		0.02			; 1: Delay Time
		0.01			; 1: Decay Speed
		0.0001		; 1: Attack Speed
		25			; 1: Lowpass Filter Frq
		1.0			; Limter 2/Max Lvl
		0.0025		; 2: Delay Time
		0.5			; 2: Decay Speed
		0.0025		; 2: Attack Speed
		200			; 2: Lowpass Filter Frq
;==================================================

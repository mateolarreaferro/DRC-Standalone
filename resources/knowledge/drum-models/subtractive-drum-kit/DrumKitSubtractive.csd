...
;===============================================================================================
	...
	instr 1	; DRUM MACHINE
kstep 	init 	0

;------------------------------------------------------------------------- ; SEQUENCER SECTION

loop1:
	kdur 	table 	kstep, p5		; READ ALL OF THE TABLE VALUES.
...
next2:
	if	(kdrnum != 2) goto next3			; DUMB BASS DRUM
		asig 	rand 	kampenv3
...
next3:
	if 	(kdrnum != 3) goto next4			; KS SNARE
		aout		=	kampenv4*asig4
			goto endswitch
...
next4:
	if		(kdrnum != 4) goto next5			; SORTA COOL KNOCK SWEEP DRUM
		asig 	rand 	kampenv5
...
next5:
	if		(kdrnum != 5) goto endswitch		; FM METAL BOINK DRUM
		aout 	= 	asig5
...
;===============================================================================================
	...
	instr 5	; SORTA COOL KNOCK SWEEP DRUM
...
f2 0 1024 7 1 1024 1   ; GEN7
;======================
	
; Duration
;========================================================
f21 0 8 -2 1	1	1	1	1	1	1	1	; GEN2
f25 0 8 -2 4	1	1	2	4	1	1	2	; GEN2
f29 0 8 -2 4	1	1	1	1	4	2	2 	; GEN2
;========================================================

; Drums : 0=HiHat, 1=Tap, 2=Bass, 3=KS Snare, 4=Sweep, 5=FMBoink 
;================================================================
f22 0 8 -2 0	1	0	1	2	1	0	1	; GEN2
f26 0 8 -2 4	3	3	2	4	2	3	4	; GEN2
f30 0 8 -2 4	2	1	5	4	5	5	4	; GEN2
;================================================================

; Panning
;===================================================
f23 0 8 -2 1 0	1	0	1	0	1	1	; GEN2
f24 0 8 -2 0 1	0	1	1	1	1	0	; GEN2
f27 0 8 -2 1 0	1	1	0	1	1	0	; GEN2
f28 0 8 -2 0 1	0	0	1	1	0	1	; GEN2
f31 0 8 -2 0 0	0	0	0	1	1	0	; GEN2
f32 0 8 -2 1 1	1	1	1	0	1	1	; GEN2
;===================================================

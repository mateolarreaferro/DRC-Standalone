...
<CsScore>
;====================================================================;
;       test score for DX7 alg 5 orc                                ;
;                                                                    ;
;       (imitates the BELL-FLUTE voice...sort of)                    ;
;                                                                    ;
...
f11     0       8       -7      0       8       7
f12   0    32    -2    99    0   74   28   39   46   
        99   58   0   0   
        0   0   1.000000   -7   
        0   
f13   0    32    -2    73    0   46   39   25   38   
        73   95   73   0   
        0   0   1.000000   2   
        0   
f14   0    32    -2    97    3   27   99   37   45   
        0   99   0   0   
        0   0   1.000000   7   
        1   
f15   0    32    -2    76    0   85   21   25   45   
        92   58   0   0   
        0   0   6.000000   -2   
        0   
f16   0    32    -2    92    3   23   99   37   45   
        0   98   0   0   
        0   0   1.000000   0   
        1   
f17   0    32    -2    76    0   85   21   25   45   
        99   58   0   0   
        0   0   8.000000   4   
        0   
...
t 0 10
i01 0 2.49 6.00 87 0 64 4 35 
 12 13 14 15 16 17 2 4000
 3 8 4 6 10 9 11 0
; Algorithm = 5
; Patch name is BELL-FLUTE

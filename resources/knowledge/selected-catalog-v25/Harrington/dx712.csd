...
<CsScore>
;====================================================================;
;       Test score for DX7 alg 12 orc                                ;
;                                                                    ;
;       (imitates the PIPES  DB  voice...sorta)                      ;
;                                                                    ;
...
f11     0       8       -7      0       8       7
f12   0    32    -2    99    1   57   25   25   45   
        99   99   98   0   
        0   0   2.000000   0   
        3   
f13   0    32    -2    94    1   59   61   62   50   
        84   80   80   0   
        0   0   2.000000   -4   
        3   
f14   0    32    -2    99    1   60   97   62   35   
        99   99   99   0   
        0   1   1.000000   6   
        5   
f15   0    32    -2    96    0   61   25   25   30   
        99   99   99   79   
        0   0   0.500000   2   
        7   
f16   0    32    -2    78    5   61   25   25   61   
        99   99   93   0   
        0   0   5.000000   -2   
        3   
f17   0    32    -2    68    2   24   31   25   70   
        99   99   99   0   
        0   0   2.000000   2   
        3   
t 0 20
i01 0 2.49 6.00 87 0 33 0 34 
 12 13 14 15 16 17 2 4000
 3 8 4 6 10 9 11 7
; Algorithm = 12
; Patch name is PIPES  DB 

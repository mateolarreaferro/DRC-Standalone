...
<CsScore>
;====================================================================;
;       test score for DX7 alg 9 orc                                ;
;                                                                    ;
;       (imitates the R.F-JARRE1 voice...sort of)                    ;
;                                                                    ;
...
f11     0       8       -7      0       8       7
f12   0    32    -2    99    0   31   15   10   30   
        99   92   0   0   
        0   0   1.000000   -1   
        0   
f13   0    32    -2    82    0   99   15   10   30   
        99   92   0   0   
        0   0   1.000000   7   
        0   
f14   0    32    -2    99    0   40   15   10   30   
        99   92   0   0   
        0   0   1.000000   -7   
        0   
f15   0    32    -2    71    0   43   15   10   30   
        99   92   0   0   
        0   0   1.000000   0   
        0   
f16   0    32    -2    66    0   43   15   10   30   
        99   92   0   0   
        0   0   2.000000   0   
        0   
f17   0    32    -2    62    0   43   15   10   30   
        99   92   0   0   
        0   0   4.000000   0   
        0   
t 0 20
i01 0 2.49 6.00 87 0 73 14 35 
 12 13 14 15 16 17 2 4000
 3 8 4 6 10 9 11 7
; Algorithm = 9
; Patch name is R.F-JARRE1

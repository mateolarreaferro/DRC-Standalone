...
<CsScore>
;====================================================================;
;       test score for DX7 alg 2 orc                                ;
;                                                                    ;
;       (imitates the STRINGS 7  voice...sort of)                    ;
;                                                                    ;
...
f11     0       8       -7      0       8       7
f12   0    32    -2    99    0   56   33   40   47   
        99   87   89   0   
        0   0   1.000000   3   
        0   
f13   0    32    -2    78    1   79   68   62   40   
        99   99   99   0   
        0   0   1.000000   -2   
        2   
f14   0    32    -2    96    1   48   33   40   47   
        99   87   89   0   
        0   0   1.500000   3   
        0   
f15   0    32    -2    73    1   79   68   62   40   
        99   99   99   0   
        0   0   1.500000   0   
        2   
f16   0    32    -2    79    0   46   60   40   40   
        87   87   93   0   
        0   0   3.000000   0   
        0   
f17   0    32    -2    68    1   94   31   98   20   
        98   1   78   0   
        0   0   1.500000   -3   
        1   
...
t 0 40
i01 0 .49 6.00 87 0 35 15 33 
 12 13 14 15 16 17 2 4000
 3 8 4 6 10 9 11 7
; Algorithm = 2
; Patch name is STRINGS 7 
